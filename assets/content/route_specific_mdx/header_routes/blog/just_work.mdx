...
authors: [{name : Ed, url : https://edondigital.netlify.app/about}, {name: Tailwindlabs, url: https://github.com/tailwindlabs/tailwindcss-typography/blob/master/demo/components/MarkdownSample.mdx}]
tags: 
  - test
  - styling
...
import YtEmbed from '../../components/specifically_for_mdx/YtEmbed.jsx'
...
//       // Server-side rendering: Render nothing or a placeholder
//       return null;
//   } else {
//       // Client-side rendering: Render the actual component
...
["yt embed"](https://www.youtube.com/embed/dQw4w9WgXcQ)

<YtEmbed url="https://www.youtube.com/embed/dQw4w9WgXcQ" />

```jsx custom react component imported into mdx!
<Boxy variant="danger" />
...
```jsx And that's a code block of jsx
  <h2 style={{ color: 'red' }}> That's JSX wrote directly {"in " + "MDX"}</h2>
```
