...
**Before reading**. Ed's notes: I did not write any of this, that's just to demonstrate what the blog has to offer. Check [the people who wrote this](https://github.com/tailwindlabs/tailwindcss-typography/blob/master/demo/components/MarkdownSample.mdx). To see how I made this work you can view the [source code of this website](https://github.com/taniarascia/taniarascia.com). Unified + tailwind typography plugin
