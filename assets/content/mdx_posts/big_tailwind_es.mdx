...
**Before reading**. Ed's notes: I did not write any of this, that's just to demonstrate what the plugin has to offer and at least a post on the blog :'). I've done some modifications in how the styles are rendered but nothing too crazy for now. You can check the people who wrote this [here](https://github.com/tailwindlabs/tailwindcss-typography/blob/master/demo/components/MarkdownSample.mdx). Eventually, I'll share the source code of the entire website so you'll be able to see the implementation.
