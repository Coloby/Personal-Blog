---
title: 'Tailwind typography plugin show off'
...
thumbnail: tailwindcssv3.4.jpg
author: 'Tailwind community'
publishDate: 'Sep 5, 2023 '
---
---

**Before reading**. Ed's notes: I did not write any of this, that's just to demonstrate what the plugin has to offer and at least a post on the blog :'). I've made some modifications to how the styles are rendered but nothing too crazy. You can check the people who wrote this [here](https://github.com/tailwindlabs/tailwindcss-typography/blob/master/demo/components/MarkdownSample.mdx). To see how I made this work you can view the source code of this website [here](https://github.com/taniarascia/taniarascia.com).
