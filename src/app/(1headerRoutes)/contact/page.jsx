              ...
              <div className="relative overflow-visible">
                ...
                <h2 className="text-center flexy sl:gap-4 !flex-col">
                  <span className="flexy">
                    <Btn classContainer="!mr-0" classBorder={"!top-[10px] !right-[-10px]"} href="mailto:edondigital@gmail.com" classContainer={"lg:ml-[10px] lg:mr-[25px] text-xl xs:text-[38px] font-black leading-[71px] tracking-widest"} >
                ...
                <div className=" flex-col ss:flex-row flex gap-4 items-center text-primary_text_color no-underline bg-[#5662f6] p-4 rounded-sm">
                  ...
                  <div className="flexy flex-col gap-4">
                    <div className="flex gap-4 flex-col sm:flex-row">
                      <Btn classContainer="!mr-0" href="https://discord.gg/txUV5fqG"><div className="flexy w-full text-center">Join the server</div></Btn>
