          ...
          <div className="w-full max-w-[780px] h-[609px] flex flex-col justify-between">
            <div className="flexy flex-col sm:gap-4 relative">
              <div className="relative overflow-visible">
                ...
                <h2 className="text-center flexy sl:gap-4 !flex-col"><span className="flexy"><Btn text={"E-mail me"} href="mailto:edondigital@gmail.com" classNameContainer={"lg:ml-[10px] lg:mr-[25px] text-xl xs:text-[38px] font-black leading-[71px] tracking-widest"}/></span><span className="text-xl xs:text-[30px] font-extrabold mt-6 tracking-widest">or Contact me</span></h2>
              </div>
