...
const page = async () => {
  ...
  const StuffILove = await getMdxComp("header_routes/contact", "convos_I_love.mdx")
  ...
  return (
    <section className="w-full h-full flex flex-col">
      ...
      <div className="absolute h-full !w-[calc(100vw+20px)] z-1 top-0 left-[-20px] overflow-hidden">
        ...
        <div className="top-0 h-full w-full bg-secondary border-t-primary border-t-[10px]"></div>
      </div>
      {/* Hero */}
      <div className="sl:h-[calc(846px-180px)] pb-[774px] flexy !items-start z-10">
        <div className="w-full flexy justify-between sl:mt-12 !flex-col sl:!flex-row sl:h-[calc(846px-300px)] gap-32">
          {/* Ghost w phone */}
          <div className="absolute top-[925px] ml-auto mr-auto sl:ml-0 sl:mr-0 object-left sl:top-0 sl:relative !w-full max-w-[609px] h-full min-h-[400px] sm:min-h-[609px] max-h-[609px] rounded-tl-[150px] rounded-br-[150px] overflow-hidden border border-primary flexy gap-2.5">
            <div className="w-full max-w-[570px] h-full max-h-[570px] origin-top-left shadow border-2 border-primary flex-col flexy gap-2.5  rounded-tl-[150px] rounded-br-[150px]">
              <div className="w-full max-w-[620px] h-full max-h-[620px] sm:overflow-hidden absolute rotate-45 sm:border-4 border-primary flexy gap-2.5 sm:shadow-[0_0px_16px_-4px] !shadow-primary">
                <div className="w-full max-w-[564px] h-full max-h-[564px] sm:border-4 border-primary absolute flexy gap-2.5 ">
                  <div className="w-full max-w-[764px] h-full max-h-[764px] border-4 -rotate-45 border-primary absolute flexy gap-2.5 ">
                    <div className="w-full max-w-[521px] h-full max-h-[521px] border-4 border-primary absolute flexy gap-2.5 sm:overflow-hidden sm:shadow-[0_0px_16px_-4px] !shadow-primary">
                      <Image
                        src="/assets/routes_specific/contact/cat_ghost_w_phone.png"
                        width={600}
                        height={600}
                        className="w-full w-500px max-w-[772.10px] h-full scale-[1.01] max-h-[623px] object-left object-cover origin-top-left border border-primary"
                        alt=""
                        priority={true}
                      />
                    </div>
          ...
          <div className="w-full max-w-[780px] h-[609px] flex flex-col justify-between">
            ...
            <div className="flex flex-col gap-16 mt-16 items-center justify-center ml-4 mr-2 sl:mx-16">
              <div className="relative z-20 w-full !mr-4">
                {/* crown */}
                <div className="w-[62px] rotate-[-6deg] !z-[11] h-[41px] left-[-24px] top-[-27px] absolute ">
              ...
              <div className="relative lg:ml-[50px] w-full !mr-4">
                <Btn classContainer="!mr-0" classBorder={"!top-[10px] !right-[-10px]"} href="https://twitter.com/edondigital" target="_blank" rel="noopener noreferrer">
                  <div className="h-20 justify-start items-center gap-10 flex !w-full">
                    ...
                    <div className="text-lg font-normal hidden sm:block">Little bits of knowledge and updates :P</div>
                  </div>
                </Btn>
              </div>
              <div className="relative lg:ml-[100px] w-full !mr-4">
                <Btn classContainer="!mr-0" classBorder={"!top-[10px] !right-[-10px]"} href="https://github.com/coloby" target="_blank" rel="noopener noreferrer">
                  <div className="h-20 justify-start items-center gap-10 flex !w-full">
                    ...
                    <div className="text-lg font-normal hidden sm:block">Where the "programming magic" happens</div>
                  </div>
                </Btn>
              </div>
            </div>
      ...
      <div className="h-fit z-10">
        <div className=" border-t-primary border-t-[10px] w-full mt-[80px] bg-secondary h-full ">
              ...
              <div className="!z-10 relative">
                <div className="flex flex-col xl:flex-row gap-[100px] lg:gap-[200px] px-4 xl:px-8">
                  ...
                  <div className="max-w-[650px] w-full h-fit relative">
                    <div className="shadow-[0_0px_16px_-4px] shadow-primary w-[calc(100%+40px)] px-4 left-[-20px] top-[24.02px] absolute bg-secondary z-10 rounded-tl-[22px] rounded-br-[22px] border-2 border-red-600 justify-center items-center gap-0.5 inline-flex">
                      <div className="flexy text-center bg-secondary flex-col ss:flex-row"><span className=" text-xl py-2 lg:text-[40px] font-semibold">Conversations&nbsp;</span><span> </span><span className="text-red-600  text-xl py-2 lg:text-[40px] font-semibold"> I hate {">:("}</span></div>
                    </div>
                    <div className="w-full px-4 pt-[130px] ss:pt-[90px] lg:pt-[130px] pb-8 left-[17px] top-0 bg-secondary rounded-tl-[22px] rounded-br-[22px] border-2 border-red-600 flex-col justify-start items-center gap-2.5 inline-flex">
                      <StuffIHate />
                    </div>
                  </div>
                  {/* Love */}
                  <div className="max-w-[650px] w-full h-fit relative">
                    <div className="shadow-[0_0px_16px_-4px] shadow-[#CC00FF] w-[calc(100%+40px)] px-4 left-[-20px] top-[24.02px] absolute bg-secondary z-10 rounded-tl-[22px] rounded-br-[22px] border-2 border-[#CC00FF] justify-center items-center gap-0.5 inline-flex">
                      <div className="flexy text-center bg-secondary flex-col ss:flex-row"><span className=" text-xl py-2 lg:text-[40px] font-semibold">Conversations&nbsp;</span><span> </span><span className="text-[#CC00FF]  text-xl py-2 lg:text-[40px] font-semibold"> I love {"<3"}</span></div>
                    </div>
                    <div className="w-full px-4 pt-[130px] ss:pt-[90px] lg:pt-[130px] pb-8 left-[17px] top-0 bg-secondary rounded-tl-[22px] rounded-br-[22px] border-2 border-[#CC00FF] flex-col justify-start items-center gap-2.5 inline-flex">
                      <StuffILove />
                    </div>
                  </div>
                </div>
