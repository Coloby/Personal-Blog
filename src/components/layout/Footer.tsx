...
const Footer = () => {
  return (
    <footer className="px-[16px] flex-col sm:flex-row text-center !items-start h-fit z-20 bg-footer_shade w-full flexy !absolute bottom-[-168px] sm:bottom-[-108px] gap-16 py-4">
      <div className="flexy flex-col gap-3 w-full sm:w-fit">
        <p className="!text-primary_text_color">The whole website it's<br />still in progress! 👷‍♂️</p>
      </div>
      <Link href="/credits" className="w-full sm:w-fit">Credits</Link>
      <div className="flexy !flex-col gap-3 w-full sm:w-fit">
        <p>The website is open source!</p>
        <a href="https://github.com/Coloby/Personal-Blog" className=" !text-primary_text_color">
